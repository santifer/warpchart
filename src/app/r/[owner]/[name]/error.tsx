    ...
    <main className="mx-auto flex max-w-[1440px] flex-col gap-4 px-3 py-4 sm:px-6 sm:py-6">
      <div className="hud flex flex-col items-start gap-4 border-warn/40 px-6 py-8">
        <div className="flex items-center gap-3">
          ...
          <span className="font-display text-[11px] tracking-[0.3em] text-warn">
            TELEMETRY LINK FAILED
          </span>
        </div>
        <p className="numeral max-w-xl text-[11px] leading-relaxed text-dim">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => reset()}
            className="numeral border border-accent/40 px-4 py-2 text-[11px] tracking-[0.2em] text-accent transition-colors hover:bg-accent/10"
          >
            ▶ RETRY SCAN
          </button>
          <a
